...
awk -F ' ' '{print $1" "$7" "$8" "$3" "$4}' $1 > step1.jo #input file is output of the final report merger, considered the reference population for SNP coding.
...
echo "ID SNP_ID AB_Genotype GCTA_Genotype" >final_header.jo
